...
class EvaluationTB(models.Model):
    ...
    OverallProfRate = models.DecimalField(max_digits=2, decimal_places=2, null=False, blank=False)
    ProfDifficulty = models.DecimalField(max_digits=2, decimal_places=2, null=False, blank=False)
    RetakeProf = models.BooleanField(null=False, blank=False)
    BigSkyUsageRate = models.DecimalField(max_digits=2, decimal_places=2, null=False, blank=False)
    ProfAttendance = models.DecimalField(max_digits=2, decimal_places=2, null=False, blank=False)
    GradeReceived = models.DecimalField(max_digits=2, decimal_places=2, null=True, blank=True)
